...
static const _UpperJointData_type_support_symbol_names_t _UpperJointData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crb_ros_msg, msg, UpperJointData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crb_ros_msg, msg, UpperJointData)),
  }
};
...
{
  return &::crb_ros_msg::msg::rosidl_typesupport_cpp::UpperJointData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crb_ros_msg, msg, UpperJointData)() {
  return get_message_type_support_handle<crb_ros_msg::msg::UpperJointData>();
}
